...
app.ticker.add((delta) => {
    ...
    if (vreme < 0) {
        ...
        sargarepa.position.x = Math.floor(Math.random() * app.view.width - sargarepa.width)
        sargarepa.position.y = Math.floor(Math.random() * app.view.height - sargarepa.height)
...
document.getElementById("speedx").addEventListener("onSliderChanged", function (e) {
    brzina[0] = e.detail.value * 5;
});

document.getElementById("speedy").addEventListener("onSliderChanged", function (e) {
